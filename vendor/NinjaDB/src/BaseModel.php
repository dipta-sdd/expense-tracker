...
class BaseModel
{
	 ...
	 * @return $this
	 */
	public function leftJoin($table, $column1, $operator = '=', $column2 = null)
	{
		return $this->normal_join('LEFT', $table, $column1, $operator, $column2);
	}
	 ...
	 * @return $this
	 */
	public function rightJoin($table, $column1, $operator = '=', $column2 = null)
	{
		return $this->normal_join('RIGHT', $table, $column1, $operator, $column2);
	}
	 ...
	 * @return $this
	 */
	public function join($table, $column1, $operator = '=', $column2 = null)
	{
		return $this->normal_join('INNER', $table, $column1, $operator, $column2);
	}
	 ...
	 * @return $this
	 */
	public function fullJoin($table, $column1, $operator = '=', $column2 = null)
	{
		return $this->normal_join('FULL', $table, $column1, $operator, $column2);
	}
	 ...
	 * @return $this
	 */
	private function normal_join($type, $table, $column1, $operator = '=', $column2 = null)
	{
		if ($column2 === null) {
			$column2 = $operator;
			$operator = '=';
		...
		/*
		* every table need to renamed using 'as . Examplae: 'expense_tracker_groups as groups'
		*/

		// if (strpos($column1, '.') !== false) {
		// 	$column1 = $this->db->prefix . $column1;
		// }
		// if (strpos($column2, '.') !== false) {
		// 	$column2 = $this->db->prefix . $column2;
		// }
		$this->selected_table = $this->selected_table . ' ' . $type . ' JOIN ' . $this->db->prefix . $table . ' ON ' . $column1 . '  ' . $operator . '  ' . $column2;
		return $this;
	}
